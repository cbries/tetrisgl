...
//
/// AUTHOR: Christian Benjamin Ries (Christian.Ries@linux-sources.de)
...
void glInfo::printSelf()
{
	...
	ss << "Max 3D Texture Size: " << this->max3dTextureSize << "x" << this->max3dTextureSize << "x" << this->max3dTextureSize << endl;
